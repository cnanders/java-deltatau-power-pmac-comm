...
public class SshConnectionManager {
	...
	private static String password = "deltatau";
	private static String hostname = "192.168.20.23";
	...
	private static String sendAndReceive(String command)
	{
	...
	private static void gpasciiInit()
	{
	 ...
	 * @return
	 */
	private static String gpasciiQuery(String command)
	{
	...
	private static void gpasciiCommand(String command)
	{
	 ...
	 * @return byte[]
	 */
	private static byte[] removeTerminatorBytesFromEnd(byte[] original)
	{
	 ...
	 * @return boolean
	 */
	private static boolean containsTerminatorByteAtEnd(byte[] bytes)
	{
		if (bytes.length == 0) {
			return false;
		}
	 ...
	 * @return boolean
	 */
	private static boolean containsAcknowledgementAndTerminatorBytesAtEnd(byte[] bytes)
	{
		if (bytes.length < 3) 
		{
			return false;
	 ...
	 * @return boolean
	 */
	private static boolean containsAsciiInputAndTerminatorBytesAtEnd(byte[] bytes)
	{
	...
	private static byte[] readChannelToTerminator(Channel channel){
	...
	private static byte[] readChannelToAcknowledgement(Channel channel){
	...
	private static byte[] readChannelToAscii(Channel channel){
	...
	public static String stringifyQueryResponse(byte[] response)
	{
	...
	public static void main(String[] args){
	    ...
	    String result11 = sendAndReceive("echo 15");
	    ...
	    commands.clear();
	    commands.add("RepCS1X");
	    executeCommands(commands);
	    */
	    
	    //System.out.println(result1);
	    
	    //gpasciiCommand("NewWorkingMode=wm_ACTIVATE");
	    
	    //String a = ;
	    System.out.println(gpasciiQuery("RepCS1X"));
	    System.out.println(gpasciiQuery("RepCS1Y"));
	    System.out.println(gpasciiQuery("RepCS2X"));
	    System.out.println(gpasciiQuery("RepCS2Y"));
	    
	    //String result = gpasciiQuery("RepCS1X");
	    
	    //gpasciiCommand("NewWorkingMode=wm_ACTIVATE");
	    //System.out.println(gpasciiQuery("ActWorkingMode"));
